...
{
	{ "Up",               false, "STRZAŁKA W GÓRĘ",           ":/help/dpad_up.svg" },
	{ "Down",             false, "STRZAŁKA W DÓŁ",         ":/help/dpad_down.svg" },
	{ "Left",             false, "STRZAŁKA W LEWO",         ":/help/dpad_left.svg" },
	{ "Right",            false, "STRZAŁKA W PRAWO",        ":/help/dpad_right.svg" },
	{ "Start",            true,  "START",              ":/help/button_start.svg" },
	{ "Select",           true,  "SELECT",             ":/help/button_select.svg" },
	{ "A lub ×",                false, "BUTTON A / EAST",    ":/help/buttons_east.svg" },
	{ "B lub ○",                true,  "BUTTON B / SOUTH",   ":/help/buttons_south.svg" },
	{ "X lub □",                true,  "BUTTON X / NORTH",   ":/help/buttons_north.svg" },
	{ "Y lub △",                true,  "BUTTON Y / WEST",    ":/help/buttons_west.svg" },
	{ "LeftShoulder",     true,  "LEWY BUMPER",      ":/help/button_l.svg" },
	{ "RightShoulder",    true,  "PRAWY BUMPER",     ":/help/button_r.svg" },
	{ "LeftTrigger",      true,  "LEWY SPUST",       ":/help/button_lt.svg" },
	{ "RightTrigger",     true,  "PRAWY SPUST",      ":/help/button_rt.svg" },
	{ "LeftThumb",        true,  "WCISNĄĆ LEWY DRĄŻEK",         ":/help/analog_thumb.svg" },
	{ "RightThumb",       true,  "WCISNĄĆ PRAWY DRĄŻEK",        ":/help/analog_thumb.svg" },
	{ "LeftAnalogUp",     true,  "LEWY DRĄŻEK W GÓRĘ",     ":/help/analog_up.svg" },
	{ "LeftAnalogDown",   true,  "LEWY DRĄŻEK W DÓŁ",   ":/help/analog_down.svg" },
	{ "LeftAnalogLeft",   true,  "LEWY DRĄŻEK W LEWO",   ":/help/analog_left.svg" },
	{ "LeftAnalogRight",  true,  "LEWY DRĄŻEK W DÓŁ",  ":/help/analog_right.svg" },
	{ "RightAnalogUp",    true,  "PRAWY DRĄŻEK W GÓRĘ",    ":/help/analog_up.svg" },
	{ "RightAnalogDown",  true,  "PRAWY DRĄŻEK W DÓŁ",  ":/help/analog_down.svg" },
	{ "RightAnalogLeft",  true,  "PRAWY DRĄŻEK W LEWO",  ":/help/analog_left.svg" },
	{ "RightAnalogRight", true,  "PRAWY DRĄŻEK W PRAWO", ":/help/analog_right.svg" },
	{ "HotKeyEnable",     true,  "PRZYCISK SKRÓTÓW",      ":/help/button_hotkey.svg" }
};
	...
	mTargetConfig(target), mHoldingInput(false), mBusyAnim(window)
{
	...
	mTitle = std::make_shared<TextComponent>(mWindow, "KONFIGUROWANIE", Font::get(FONT_SIZE_LARGE), 0x555555FF, ALIGN_CENTER);
	...
	mSubtitle2 = std::make_shared<TextComponent>(mWindow, "WCIŚNIJ DOWOLNY PRZYCISK ABY POMINĄĆ", Font::get(FONT_SIZE_SMALL), 0x99999900, ALIGN_CENTER);
	...
	for(int i = 0; i < inputCount; i++)
	{
		...
		auto mapping = std::make_shared<TextComponent>(mWindow, "– NIEPRZYPISANY –", Font::get(FONT_SIZE_MEDIUM, FONT_PATH_LIGHT), 0x999999FF, ALIGN_RIGHT);
	...
	// make the first one say "NACIŚNIJ COKOLWIEK." if we're re-configuring everything
	if(mConfiguringAll)
	...
	if(mConfiguringRow && mHoldingInput && GUI_INPUT_CONFIG_LIST[mHeldInputId].skippable)
	{
		...
		if(mHeldTime >= HOLD_TO_SKIP_MS)
		{
			...
			if(prevSec != curSec)
			{
				...
				std::stringstream ss;
				ss << "HOLD FOR " << HOLD_TO_SKIP_MS/1000 - curSec << "S ABY POMINĄĆ";
				text->setText(ss.str());
...
{
	text->setText("WYBRANY WCZEŚNIEJ");
	text->setColor(0x656565FF);
}
