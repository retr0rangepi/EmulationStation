...
{
	{ "Up",               false, "D-PAD YUKARI",           ":/help/dpad_up.svg" },
	{ "Down",             false, "D-PAD AŞAĞI",         ":/help/dpad_down.svg" },
	{ "Left",             false, "D-PAD SOL",         ":/help/dpad_left.svg" },
	{ "Right",            false, "D-PAD SAĞ",        ":/help/dpad_right.svg" },
	...
	{ "LeftShoulder",     true,  "SOL OMUZ L1",      ":/help/button_l.svg" },
	{ "RightShoulder",    true,  "SAĞ OMUZ R1",     ":/help/button_r.svg" },
	{ "LeftTrigger",      true,  "SOL TETİK L2",       ":/help/button_lt.svg" },
	{ "RightTrigger",     true,  "SAĞ TETİK R2",      ":/help/button_rt.svg" },
	{ "LeftThumb",        true,  "SOL BAŞPARMAK L3",         ":/help/analog_thumb.svg" },
	{ "RightThumb",       true,  "SAĞ BAŞPARMAK R3",        ":/help/analog_thumb.svg" },
	{ "LeftAnalogUp",     true,  "SOL ANALOG YUKARI",     ":/help/analog_up.svg" },
	{ "LeftAnalogDown",   true,  "SOL ANALOG AŞAĞI",   ":/help/analog_down.svg" },
	{ "LeftAnalogLeft",   true,  "SOL ANALOG SOL",   ":/help/analog_left.svg" },
	{ "LeftAnalogRight",  true,  "SOL ANALOG SAĞ",  ":/help/analog_right.svg" },
	{ "RightAnalogUp",    true,  "SAĞ ANALOG YUKARI",    ":/help/analog_up.svg" },
	{ "RightAnalogDown",  true,  "SAĞ ANALOG AŞAĞI",  ":/help/analog_down.svg" },
	{ "RightAnalogLeft",  true,  "SAĞ ANALOG SOL",  ":/help/analog_left.svg" },
	{ "RightAnalogRight", true,  "SAĞ ANALOG SAĞ", ":/help/analog_right.svg" },
	{ "HotKeyEnable",     true,  "KISAYOL TUŞU ETKİN",      ":/help/button_hotkey.svg" }
};
	...
	mTargetConfig(target), mHoldingInput(false), mBusyAnim(window)
{
	...
	mTitle = std::make_shared<TextComponent>(mWindow, "YAPILANDIRILIYOR", Font::get(FONT_SIZE_LARGE), 0x555555FF, ALIGN_CENTER);
	...
	mSubtitle2 = std::make_shared<TextComponent>(mWindow, "ATLAMAK İÇİN HERHANGİ BİR TUŞA BASIN", Font::get(FONT_SIZE_SMALL), 0x99999900, ALIGN_CENTER);
	...
	for(int i = 0; i < inputCount; i++)
	{
		...
		auto mapping = std::make_shared<TextComponent>(mWindow, "-TANIMLI DEĞİL-", Font::get(FONT_SIZE_MEDIUM, FONT_PATH_LIGHT), 0x999999FF, ALIGN_RIGHT);
	...
	// make the first one say "HERHANGİ BİR TUŞA BASIN" if we're re-configuring everything
	if(mConfiguringAll)
	...
	if(mConfiguringRow && mHoldingInput && GUI_INPUT_CONFIG_LIST[mHeldInputId].skippable)
	{
		...
		if(mHeldTime >= HOLD_TO_SKIP_MS)
		{
			...
			if(prevSec != curSec)
			{
				...
				std::stringstream ss;
				ss << "BASILI TUTUN " << HOLD_TO_SKIP_MS/1000 - curSec << "ATLAMAK İÇİN S 'e BASIN";
				text->setText(ss.str());
