...
static const InputConfigStructure GUI_INPUT_CONFIG_LIST[inputCount] =
{
	...
	{ "Start",            true,  "開始",              ":/help/button_start.svg" },
	{ "Select",           true,  "選擇",             ":/help/button_select.svg" },
	...
	{ "LeftShoulder",     true,  "LEFT SHOULDER L8",      ":/help/button_l.svg" },
	{ "RightShoulder",    true,  "RIGHT SHOULDER R8",     ":/help/button_r.svg" },
	{ "LeftTrigger",      true,  "LEFT TRIGGER L9",       ":/help/button_lt.svg" },
	{ "RightTrigger",     true,  "RIGHT TRIGGER R9",      ":/help/button_rt.svg" },
	{ "LeftThumb",        true,  "LEFT THUMB L10",         ":/help/analog_thumb.svg" },
	{ "RightThumb",       true,  "RIGHT THUMB R10",        ":/help/analog_thumb.svg" },
	...
	{ "HotKeyEnable",     true,  "開啟熱鍵",      ":/help/button_hotkey.svg" }
};
	...
	mTargetConfig(target), mHoldingInput(false), mBusyAnim(window)
{
	...
	// make the first one say "請按鍵" if we're re-configuring everything
	if(mConfiguringAll)
