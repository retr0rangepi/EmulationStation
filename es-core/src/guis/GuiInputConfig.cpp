...
{
	{ "Up",               false, "D-PAD CIMA",           ":/help/dpad_up.svg" },
	{ "Down",             false, "D-PAD BAIXO",         ":/help/dpad_down.svg" },
	{ "Left",             false, "D-PAD ESQUERDA",         ":/help/dpad_left.svg" },
	{ "Right",            false, "D-PAD DIREITA",        ":/help/dpad_right.svg" },
	...
	{ "LeftShoulder",     true,  "L1",      ":/help/button_l.svg" },
	{ "RightShoulder",    true,  "R1",     ":/help/button_r.svg" },
	{ "LeftTrigger",      true,  "L2",       ":/help/button_lt.svg" },
	{ "RightTrigger",     true,  "R2",      ":/help/button_rt.svg" },
	{ "LeftThumb",        true,  "L3",         ":/help/analog_thumb.svg" },
	{ "RightThumb",       true,  "R3",        ":/help/analog_thumb.svg" },
	{ "LeftAnalogUp",     true,  "ANALÓGICO CIMA (E)",     ":/help/analog_up.svg" },
	{ "LeftAnalogDown",   true,  "ANALÓGICO BAIXO (E)",   ":/help/analog_down.svg" },
	{ "LeftAnalogLeft",   true,  "ANALÓGICO ESQUERDA (E)",   ":/help/analog_left.svg" },
	{ "LeftAnalogRight",  true,  "ANALÓGICO DIREITA. (E)",  ":/help/analog_right.svg" },
	{ "RightAnalogUp",    true,  "ANALÓGICO CIMA (D)",    ":/help/analog_up.svg" },
	{ "RightAnalogDown",  true,  "ANALÓGICO BAIXO (D)",  ":/help/analog_down.svg" },
	{ "RightAnalogLeft",  true,  "ANALÓGICO ESQUERDA (D)",  ":/help/analog_left.svg" },
	{ "RightAnalogRight", true,  "ANALÓGICO DIREITA (D)", ":/help/analog_right.svg" },
	{ "HotKeyEnable",     true,  "TECLA COMBO",      ":/help/button_hotkey.svg" }
};
	...
	mTargetConfig(target), mHoldingInput(false), mBusyAnim(window)
{
	...
	// make the first one say "PRESSIONE QUALQUER BOTÃO" if we're re-configuring everything
	if(mConfiguringAll)
	...
	if(mConfiguringRow && mHoldingInput && GUI_INPUT_CONFIG_LIST[mHeldInputId].skippable)
	{
		...
		if(mHeldTime >= HOLD_TO_SKIP_MS)
		{
			...
			if(prevSec != curSec)
			{
				...
				std::stringstream ss;
				ss << "HOLD FOR " << HOLD_TO_SKIP_MS/1000 - curSec << "S PARA PULAR";
				text->setText(ss.str());
...
{
	text->setText("PRESSIONE QUALQUER BOTÃO");
