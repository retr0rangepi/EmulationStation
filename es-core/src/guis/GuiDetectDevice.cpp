	...
	mBackground(window, ":/frame.png"), mGrid(window, Vector2i(1, 5))
{
	...
	// title
	mTitle = std::make_shared<TextComponent>(mWindow, firstRun ? "HOŞGELDİNİZ" : "GİRDİYİ YAPILANDIR", 
	...
	if(numDevices > 0)
		...
		deviceInfo << "GAMEPAD ALGILANMADİ";
	...
	// message
	mMsg1 = std::make_shared<TextComponent>(mWindow, "TUŞ YAPILANDIRMAK İÇİN CİHAZINIZDAKİ HERHANGİ BİR TUŞA BASILI TUTUN", Font::get(FONT_SIZE_SMALL), 0x777777FF, ALIGN_CENTER);
	mGrid.setEntry(mMsg1, Vector2i(0, 2), false, true);

	const char* msg2str = firstRun ? "HERHANGİ BİR ANDA ÇIKMAK İÇİN F4 'e BASIN ." : "PRESS ESC TO CANCEL.";
