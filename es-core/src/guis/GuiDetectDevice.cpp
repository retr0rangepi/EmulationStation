	...
	mBackground(window, ":/frame.png"), mGrid(window, Vector2i(1, 5))
{
	...
	// title
	mTitle = std::make_shared<TextComponent>(mWindow, firstRun ? "WITAJ" : "KONFIGURACJA WEJŚCIA", 
	...
	if(numDevices > 0)
		...
		deviceInfo << "NIE WYKRYTO KONTROLERÓW";
	...
	// message
	mMsg1 = std::make_shared<TextComponent>(mWindow, "PRZYTRZYMAJ PRZYCISK „A” NA KONTROLERZE ABY PRZEJŚĆ DO KONFIGURACJI.", Font::get(FONT_SIZE_SMALL), 0x777777FF, ALIGN_CENTER);
	mGrid.setEntry(mMsg1, Vector2i(0, 2), false, true);

	const char* msg2str = firstRun ? "NACIŚNIJ „F4” ABY ZAKOŃCZYĆ W DOWOLNYM MOMENCIE." : "NACIŚNIJ „ESC” ABY ANULOWAĆ.";
