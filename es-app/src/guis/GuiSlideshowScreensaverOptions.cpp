...
GuiSlideshowScreensaverOptions::GuiSlideshowScreensaverOptions(Window* window, const char* title) : GuiScreensaverOptions(window, title)
{
	...
	addWithLabel(row, "ÉCHANGER L´IMAGE APRÈS (SECS)", sss_image_sec);
	...
	addWithLabel(row, "ÉTIRER LES IMAGES", sss_stretch);
	...
	addEditableTextComponent(row, "MUSIQUE D´ARRIÈRE PLAN", sss_bg_audio_file, Settings::getInstance()->getString("SlideshowScreenSaverBackgroundAudioFile"));
	...
	addWithLabel(row, "UTILISER DES IMAGES PERSONNELLES", sss_custom_source);
	...
	addEditableTextComponent(row, "IMAGE DE CHEMIN PERSONNALISÉ", sss_image_dir, Settings::getInstance()->getString("SlideshowScreenSaverImageDir"));
	...
	addWithLabel(row, "IMAGE DE CHEMIN PERSONNALISÉ RECURSIF", sss_recurse);
	...
	addEditableTextComponent(row, "PERSONNALISER L´IMAGE DU FILTRE", sss_image_filter, Settings::getInstance()->getString("SlideshowScreenSaverImageFilter"));
