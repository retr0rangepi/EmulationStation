...
GuiSlideshowScreensaverOptions::GuiSlideshowScreensaverOptions(Window* window, const char* title) : GuiScreensaverOptions(window, title)
{
	...
	addWithLabel(row, "WECHSLE BILD NACH (SEK.)", sss_image_sec);
	...
	addWithLabel(row, "BILDER DEHNEN", sss_stretch);
	...
	addEditableTextComponent(row, "HINTERGRUND AUDIO", sss_bg_audio_file, Settings::getInstance()->getString("SlideshowScreenSaverBackgroundAudioFile"));
	...
	addWithLabel(row, "BENUTZE EIGENE BILDER", sss_custom_source);
	...
	addEditableTextComponent(row, "VERZEICHNIS FÜR EIGENE BILDER", sss_image_dir, Settings::getInstance()->getString("SlideshowScreenSaverImageDir"));
	...
	addWithLabel(row, "VERZEICHNIS FÜR EIGENE BILDER REKURSIV", sss_recurse);
	...
	addEditableTextComponent(row, "FILTER FÜR EIGENE BILDER", sss_image_filter, Settings::getInstance()->getString("SlideshowScreenSaverImageFilter"));
