...
GuiSlideshowScreensaverOptions::GuiSlideshowScreensaverOptions(Window* window, const char* title) : GuiScreensaverOptions(window, title)
{
	...
	addWithLabel(row, "Cambiar imagen después (segundos)", sss_image_sec);
	...
	addWithLabel(row, "Ajustar imágenes", sss_stretch);
	...
	addEditableTextComponent(row, "Música de fondo", sss_bg_audio_file, Settings::getInstance()->getString("SlideshowScreenSaverBackgroundAudioFile"));
	...
	addWithLabel(row, "Usar imágenes personalizadas", sss_custom_source);
	...
	addEditableTextComponent(row, "Directorio imágenes personalizadas", sss_image_dir, Settings::getInstance()->getString("SlideshowScreenSaverImageDir"));
	...
	addWithLabel(row, "Directorio recursivo imágenes personalizadas", sss_recurse);
	...
	addEditableTextComponent(row, "Personalizar filtro de imagen", sss_image_filter, Settings::getInstance()->getString("SlideshowScreenSaverImageFilter"));
