...
GuiSlideshowScreensaverOptions::GuiSlideshowScreensaverOptions(Window* window, const char* title) : GuiScreensaverOptions(window, title)
{
	...
	addWithLabel(row, "CAMBIA IMMAGINE DOPO (SEC)", sss_image_sec);
	...
	addWithLabel(row, "ESTENDI IMMAGINE", sss_stretch);
	...
	addEditableTextComponent(row, "AUDIO IN BACKGROUND", sss_bg_audio_file, Settings::getInstance()->getString("SlideshowScreenSaverBackgroundAudioFile"));
	...
	addWithLabel(row, "USA IMMAGINE PERSONALIZZATA", sss_custom_source);
	...
	addEditableTextComponent(row, "CARTELLA IMMAGINI", sss_image_dir, Settings::getInstance()->getString("SlideshowScreenSaverImageDir"));
	...
	addWithLabel(row, "CARTELLA IMMAGINI RICORSIVA", sss_recurse);
	...
	addEditableTextComponent(row, "FILTRO IMMAGINE PERSONALIZZATO", sss_image_filter, Settings::getInstance()->getString("SlideshowScreenSaverImageFilter"));
