...
GuiSlideshowScreensaverOptions::GuiSlideshowScreensaverOptions(Window* window, const char* title) : GuiScreensaverOptions(window, title)
{
	...
	addWithLabel(row, "(SANİYE) SONRA DEĞİŞTİR", sss_image_sec);
	...
	addWithLabel(row, "RESİMLERİ GENİŞLET", sss_stretch);
	...
	addEditableTextComponent(row, "ARKAPLAN SESİ", sss_bg_audio_file, Settings::getInstance()->getString("SlideshowScreenSaverBackgroundAudioFile"));
	...
	addWithLabel(row, "ÖZEL RESİMLER KULLAN", sss_custom_source);
	...
	addEditableTextComponent(row, "ÖZEL RESİM DİZİNİ", sss_image_dir, Settings::getInstance()->getString("SlideshowScreenSaverImageDir"));
	...
	addWithLabel(row, "ÖZEL RESİM İÇİN TEKRARLANAN DİZİN", sss_recurse);
	...
	addEditableTextComponent(row, "ÖZEL RESİM FILTRESİ", sss_image_filter, Settings::getInstance()->getString("SlideshowScreenSaverImageFilter"));
