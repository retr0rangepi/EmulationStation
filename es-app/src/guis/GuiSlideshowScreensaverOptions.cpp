...
GuiSlideshowScreensaverOptions::GuiSlideshowScreensaverOptions(Window* window, const char* title) : GuiScreensaverOptions(window, title)
{
	...
	addWithLabel(row, "MUDAR A IMAGEM APÓS (segs)", sss_image_sec);
	...
	addWithLabel(row, "AJUSTAR IMAGENS", sss_stretch);
	...
	addEditableTextComponent(row, "MÚSICA DE FUNDO", sss_bg_audio_file, Settings::getInstance()->getString("SlideshowScreenSaverBackgroundAudioFile"));
	...
	addWithLabel(row, "USAR IMAGEM PERSONALIZADA", sss_custom_source);
	...
	addEditableTextComponent(row, "LOCAL DA IMAGEM PERSON.", sss_image_dir, Settings::getInstance()->getString("SlideshowScreenSaverImageDir"));
	...
	addWithLabel(row, "LOCAL DA IMAGEM PERSON. (com subdirs)", sss_recurse);
	...
	addEditableTextComponent(row, "FILTRO PERSONALIZADO DE IMAGEM", sss_image_filter, Settings::getInstance()->getString("SlideshowScreenSaverImageFilter"));
