...
bool loadSystemConfigFile(const char** errorString)
{
	*errorString = NULL;
	...
	if(!SystemData::loadConfig())
	{
		...
		*errorString = "LA CONFIGURAZIONE DEL SISTEMA NON E' VALIDA, DEVI FARLO MANUALMENTE.\n\n"
			"VISITA EMULATIONSTATION.ORG PER MAGGIORI INFO";
		return false;
	}
	...
	if(SystemData::sSystemVector.size() == 0)
	{
		...
		*errorString = "NON POSSO TROVARE ALCUN SISTEMA!\n"
			"CONTROLLA SE L'INDIRIZZO E' CORRETTO"
