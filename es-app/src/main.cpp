...
bool loadSystemConfigFile(const char** errorString)
{
	*errorString = NULL;
	...
	if(!SystemData::loadConfig())
	{
		...
		*errorString = "A CONFIGURAÇÃO DE SISTEMAS DO ES NÃO FOI ENCONTRADA. ENTRE EM CONTATO COM O DESENVOLVEDOR..\n\n"
			"VISITE RETRORANGEPI.ORG PARA MAIORES INFORMAÇÕES.";
		return false;
	}
	...
	if(SystemData::sSystemVector.size() == 0)
	{
		...
		*errorString = "NÃO ENCONTRAMOS NENHUM SISTEMA!\n"
			"VERIFIQUE SE AS PASTAS ESTÃO CORRETAS NO ARQUIVO DE CONFIGURAÇÃO,"
